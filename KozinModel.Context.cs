...
namespace Козин_Глазки_save
{
    ...
    public partial class KozinEntities : DbContext
    {
        private static KozinEntities _context;

        public static KozinEntities GetContext()
        {
            if (_context == null)
                _context = new KozinEntities();

            return _context;
        }
        public KozinEntities()
            : base("name=KozinEntities")
        {
        }
